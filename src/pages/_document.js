  ...
  render() {
    return (
      <Html lang="tr">
        <Head>
          {/* General Meta Tags */}
          <meta name="description" content="Reportage Türkiye: Lüks gayrimenkul projeleri ve yatırım fırsatları İstanbul, Bahçeşehir, ve Dubai'de." />
          <meta name="keywords" content="luxury villas, real estate investment Turkey, Bahçeşehir villas, Sylvana Istanbul, Afra Park, Reportage Türkiye, İstanbul property, Turkish citizenship by investment, buy villa in Bahçeşehir, investment opportunities in Dubai" />
