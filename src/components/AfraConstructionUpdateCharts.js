...
const AfraConstructionUpdateCharts = () => {
  ...
  const radialOptions = useMemo(
    () => ({
        ...
        radialBar: {
          ...
          dataLabels: {
            name: {
              ...
              color: "#333",
              fontSize: "17px",
              text: t("afraConstructionUpdateCharts.constructionProgress"),
            },
            value: {
      ...
      labels: [t("afraConstructionUpdateCharts.completed")],
    }),
    [t]
  );
  ...
  return (
    ...
    >
      <div className="radial-chart">
        ...
        >
          {t("afraConstructionUpdateCharts.afraParkConstructionProgress")}
        </h2>
        <ReactApexChart
      ...
      <div className="real-time-chart mt-10">
        <h2 className="text-center text-3xl font-bold mb-6 dark:text-gray-100 text-gray-900">
          {t("afraConstructionUpdateCharts.realTimeAfraParkProgress")}
        </h2>
        <ReactApexChart
...
export default React.memo(AfraConstructionUpdateCharts);
